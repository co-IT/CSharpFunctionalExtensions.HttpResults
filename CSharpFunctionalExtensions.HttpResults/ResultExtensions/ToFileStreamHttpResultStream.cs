...
{
  /// <summary>
  ///   Returns a <see cref="FileStreamHttpResult" /> based of a Stream in case of success result. Returns
  ///   <see cref="ProblemHttpResult" /> in case of failure. You can override the error status code.
  /// </summary>
  public static Results<FileStreamHttpResult, ProblemHttpResult> ToFileStreamHttpResult<T>(
  ...
  ///   <see cref="ProblemHttpResult" /> in case of failure. You can override the error status code.
  /// </summary>
  public static async Task<Results<FileStreamHttpResult, ProblemHttpResult>> ToFileStreamHttpResult<T>(
    ...
    where T : Stream
  {
    return (await result).ToFileStreamHttpResult(
      contentType,
      fileDownloadName,
      lastModified,
      entityTag,
