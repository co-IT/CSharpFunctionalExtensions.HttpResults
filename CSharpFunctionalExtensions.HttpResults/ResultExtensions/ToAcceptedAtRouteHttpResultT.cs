...
{
  /// <summary>
  ///   Returns a <see cref="AcceptedAtRoute{TValue}" /> with Accepted status code in case of success result. Returns
  ...
  /// </summary>
  public static Results<AcceptedAtRoute<T>, ProblemHttpResult> ToAcceptedAtRouteHttpResult<T>(
  ...
  ///   can override the error status code.
  /// </summary>
  public static async Task<Results<AcceptedAtRoute<T>, ProblemHttpResult>> ToAcceptedAtRouteHttpResult<T>(
  ...
  {
    return (await result).ToAcceptedAtRouteHttpResult(
      routeName,
      routeValues,
      failureStatusCode,
