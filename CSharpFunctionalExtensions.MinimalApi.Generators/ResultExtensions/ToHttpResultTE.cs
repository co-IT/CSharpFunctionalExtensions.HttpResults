...
public partial class ResultExtensionsGenerator
{
    ...
    {
        return $$"""
                 public static {{httpResultType}} ToHttpResult<T>(this Result<T,{{resultErrorType}}> result, int successStatusCode = 200, int failureStatusCode = 400)
                 {
                 ...
                 public static async Task<{{httpResultType}}> ToHttpResult<T>(this Task<Result<T,{{resultErrorType}}>> result, int successStatusCode = 200, int failureStatusCode = 400)
                 {
