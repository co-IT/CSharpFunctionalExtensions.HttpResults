...
public partial class ResultExtensionsGenerator
{
    ...
    {
        return $$"""
               public static {{httpResultType}} ToAcceptedAtRouteHttpResult<T>(this Result<T,{{resultErrorType}}> result, string? routeName = null, object? routeValues = null, int failureStatusCode = 400)
               {
               ...
               public static async Task<{{httpResultType}}> ToAcceptedAtHttpResult<T>(this Task<Result<T,{{resultErrorType}}>> result, string? routeName = null, object? routeValues = null, int failureStatusCode = 400)
               {
