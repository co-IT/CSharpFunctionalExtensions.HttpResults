...
public class ToFileHttpResultByteArrayE
{
    ...
    public void ResultByteArrayE_Success_can_be_mapped_to_FileHttpResult()
    {
        ...
        var result = Result.Success<byte[], DocumentMissingError>(value)
    ...
    public async Task ResultByteArrayE_Success_can_be_mapped_to_FileHttpResult_Async()
    {
        ...
        var result = (await Task.FromResult(Result.Success<byte[], DocumentMissingError>(value))
            .ToFileHttpResult(contentType, fileDownloadName, lastModified, entityTag, enableRangeProcessing)).Result as FileContentHttpResult;
    ...
    public void ResultByteArrayE_Failure_can_be_mapped_to_FileHttpResult()
    {
        ...
        var result = Result.Failure<byte[], DocumentMissingError>(error)
            .ToFileHttpResult().Result as NotFound<string>;
    ...
    public async Task ResultByteArrayE_Failure_can_be_mapped_to_FileHttpResult_Async()
    {
        ...
        var result = (await Task.FromResult(Result.Failure<byte[], DocumentMissingError>(error))
            .ToFileHttpResult()).Result as NotFound<string>;
