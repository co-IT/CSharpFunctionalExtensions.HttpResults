...
public class ToFileStreamHttpResultStream
{
    ...
    public void ResultStream_Success_can_be_mapped_to_FileStreamHttpResult()
    {
        ...
        var result = Result.Success(stream)
    ...
    public async Task ResultStream_Success_can_be_mapped_to_FileStreamHttpResult_Async()
    {
        ...
        var result = (await Task.FromResult(Result.Success(stream))
            .ToFileStreamHttpResult(contentType, fileDownloadName, lastModified, entityTag, enableRangeProcessing)).Result as FileStreamHttpResult;
    ...
    public void ResultStream_Failure_can_be_mapped_to_FileStreamHttpResult()
    {
        ...
        var result = Result.Failure<Stream>(error)
            .ToFileStreamHttpResult().Result as ProblemHttpResult;
    ...
    public async Task ResultStream_Failure_can_be_mapped_to_FileStreamHttpResult_Async()
    {
        ...
        var result = (await Task.FromResult(Result.Failure<Stream>(error))
            .ToFileStreamHttpResult()).Result as ProblemHttpResult;
    ...
    public void ResultStream_Failure_StatusCode_can_be_changed()
    {
        ...
        var result = Result.Failure<Stream>(error)
            .ToFileStreamHttpResult(failureStatusCode: statusCode).Result as ProblemHttpResult;
