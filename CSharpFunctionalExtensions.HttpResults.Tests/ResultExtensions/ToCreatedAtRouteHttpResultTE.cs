...
public class ToCreatedAtRouteHttpResultTE
{
  ...
  public void ResultTE_Success_can_be_mapped_to_CreatedAtRouteHttpResult()
  {
    ...
    var result =
      Result
        .Success<Document, DocumentCreationError>(document)
  ...
  public async Task ResultTE_Success_can_be_mapped_to_CreatedAtRouteHttpResult_Async()
  {
    ...
    var result =
      (
        await Task.FromResult(Result.Success<Document, DocumentCreationError>(document))
  ...
  public void ResultTE_Failure_can_be_mapped_to_CreatedAtRouteHttpResult()
  {
    ...
    var result =
      Result.Failure<Document, DocumentCreationError>(error).ToCreatedAtRouteHttpResult().Result as Conflict<string>;
  ...
  public async Task ResultTE_Failure_can_be_mapped_to_CreatedAtRouteHttpResult_Async()
  {
    ...
    var result =
      (
        await Task.FromResult(Result.Failure<Document, DocumentCreationError>(error)).ToCreatedAtRouteHttpResult()
